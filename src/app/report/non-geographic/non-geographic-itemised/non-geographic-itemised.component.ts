...
import { NonGeographicItemisedViewModel } from 'src/app/_models/report/non-geographic-itemised.model';
...
@Component({
    selector: 'non-geographic-itemised',
    templateUrl: './non-geographic-itemised.component.html'
})
export class NonGeoraphyItemisedComponent implements OnInit {
    ...
    model: NonGeographicItemisedViewModel[];
    ...
    ngOnInit() {
        ...
        this.route.params.subscribe(params => {
            ...
            if (Object.keys(params).length > 0) {
                ...
                this.serviceused = params["su"];

                this.qparams = this.route.queryParams.subscribe(qparams => {
                    this.fromdate = qparams["fd"];
                    this.todate = qparams["td"];
                    this.fromdatedescription = qparams["fdate"];
                    this.todatedescription = qparams["tdate"];
                ...
                this.loader.emit(Promise.all([promise1, promise2]).then(() => {
                    this.refreshData();
                }));
    ...
    */
    ...
    loadRoamedReport() {
        this.loader.emit(this.invoiceReportService.GetNongeographicItemised(this.diallednumber, this.fromdate, this.todate, UtilityMethod.IfNull(this.networkguid, ''),
            ...
            UtilityMethod.IfNull(this.ban, '')).then((data) => {
                ...
                this.csvfilename = "NonGeographyItemised_" + this.fromdatedescription + "_" + this.todatedescription;
